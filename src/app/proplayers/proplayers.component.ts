...
import { IProPlayer } from '../interfaces/pro-player';
...
export class ProplayersComponent implements OnInit {
  ...
  filterThem(listFilter: string): IProPlayer[] {
    listFilter = listFilter.toLocaleLowerCase();
    return this.proPlayers.filter((player: IProPlayer) =>
      player.name.toLocaleLowerCase().includes(listFilter)
    );
  }
  filteredProPlayers: IProPlayer[] = [];
  proPlayers: IProPlayer[] = [
    {
      id: 2434,
